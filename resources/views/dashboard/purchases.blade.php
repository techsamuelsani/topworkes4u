		...
		<div class="dashboard-content">
			...
			<div class="purchases-list">
				...
				<div class="purchases-list-header">
					...
					<div style="width: 45% !important;" class="purchases-list-header-details">
				...
				<!-- /PURCHASES LIST HEADER -->
				@foreach($user->buyings as $order)
				<!-- PURCHASE ITEM -->
				<div class="purchase-item">
					<div class="purchase-item-date">
						<p>{{ date('F d, Y', strtotime($order->created_at)) }}</p>
					</div>
					<div  style="width: 45% !important;" class="purchase-item-details">
						<!-- ITEM PREVIEW -->
						<div class="item-preview">
							...
							<p class="">{{$order->service()->details}}</p>
						</div>
						<!-- /ITEM PREVIEW -->
					</div>
					<div class="purchase-item-info">
						...
						<p><span class="light">Seller:</span> <a style="color: #0fccf4;" href="\{{$order->seller()->username}}">{{$order->seller()->name}}</a></p>
					</div>
					<div class="purchase-item-price">
						<p class="price"><span>$</span>{{$order->payment->total}}</p>
					</div>
					<div class="purchase-item-download">
						<a href="\{{$user->username}}\buying\{{$order->id}}" class="button dark-light">Goto Order</a>
					</div>
				</div>
				<!-- /PURCHASE ITEM -->
				@endforeach
