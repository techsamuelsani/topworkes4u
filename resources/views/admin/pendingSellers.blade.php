        ...
        <div class="dashboard-content">
			...
			<div class="transaction-list">
				...
				<div class="transaction-list-header">
					<div style="margin-left: 5px;" class="transaction-list-header-date">
						<p class="text-header small">Date</p>
					</div>
					<div style="width: 26%;" class="transaction-list-header-author">
						<p class="text-header small">Name</p>
					</div>
					<div style="width: 26%;" class="transaction-list-header-item">
						<p class="text-header small">Username</p>
					</div>
					<div class="transaction-list-header-detail">
						<p class="text-header small">Country</p>
					</div>
					<div class="transaction-list-header-code">
						<p class="text-header small">View</p>
					</div>
					<div class="transaction-list-header-code">
						<p class="text-header small">Accept</p>
					</div>
					<div class="transaction-list-header-code">
						<p class="text-header small">Reject</p>
					</div>
				...
				<div style="overflow: hidden;" class="transaction-list-item">
					<div style="margin-left: 5px;" class="transaction-list-item-date">
						<p>{{ date('F d, Y', strtotime($user->updated_at)) }}</p>
					</div>
					<div style="width: 26%;" class="transaction-list-item-author">
						<p class="text-header"><a href="/{{$user->username}}">{{$user->name}}</a></p>
					</div>
					<div style="width: 26%;" class="transaction-list-item-item">
						<p class="category primary"><a href="/{{$user->username}}">{{$user->username}}</a></p>
					</div>
					<div class="transaction-list-item-detail">
						<p>{{$user->country}}</p>
					</div>
					<div class="transaction-list-item-code">
						<p><span class="light"><a href="/{{$user->username}}">View</a></span></p>
					</div>
					<div class="transaction-list-item-code">
