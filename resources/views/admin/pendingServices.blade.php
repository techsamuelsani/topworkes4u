			...
			<div class="transaction-list">
				...
				<div class="transaction-list-header">
					...
					<div class="transaction-list-header-author">
						<p class="text-header small">Seller</p>
					</div>
					<div style="width: 45%;" class="transaction-list-header-item">
						<p class="text-header small">Title</p>
					</div>
					<div style="width: 12%;" class="transaction-list-header-detail">
				...
				<div style="border-bottom: none; overflow: hidden;" class="transaction-list-item">
					<div class="transaction-list-item-date">
						<p>{{ date('F d, Y', strtotime($service->updated_at)) }}</p>
					</div>
					<div class="transaction-list-item-author">
						<p class="text-header"><a href="/{{$service->user->username}}">{{$service->user->name}}</a></p>
					</div>
					<div style="width: 45%;" class="transaction-list-item-item">
						<p class="category primary"><a href="service/{{$service->id}}">{{$service->title}}</a></p>
					</div>
					<div style="width: 13%;" class="transaction-list-item-detail">
						<p>{{$service->category->name}}</p>
					</div>
					<div class="transaction-list-item-code">
						<p><span class="light"><a href="service/{{$service->id}}" >View</a></span></p>
					</div>
				</div>
				<!-- /TRANSACTION LIST ITEM -->
				@endforeach
